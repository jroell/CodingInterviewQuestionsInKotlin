...
// numbers. Each digit mapped to a set of 0 - 4 letters. Implement an algorithms to return a list of matching words,
// given a sequence of digits. You are provided a list of valid words (provided in whatever data structure you'd
// like). The mapping is shown in the diagram below:

// (put picture of T9 layout)
